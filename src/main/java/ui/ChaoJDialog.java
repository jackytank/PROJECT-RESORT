...
public class ChaoJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/resort/icon/hinhnen.JPG"))); // NOI18N
        ...
        lblTrangThai.setText("Đang Khởi Động Ứng Dụng...");
        jPanel2.add(lblTrangThai, java.awt.BorderLayout.PAGE_START);
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if (i == 20) {
                            lblTrangThai.setText("   Vui Lòng Đợi Trong Giây Lát...! ");
                        }
                        if (i == 50) {
                            lblTrangThai.setText("   Đã Kết Nối Với Hệ Thống...");
                        }
                        if (i == 90) {
                            lblTrangThai.setText("   Welcome to Resort Bún Bò...");
                        }
                        if (i == 100) {
